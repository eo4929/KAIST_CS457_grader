students = []
input_filename = './chat/chat_cs459_finalpresentation_20211216.txt'
outout_filename = 'out_participation_1216.csv'

with open('students_cs459.csv', 'r', encoding='utf-8') as f:
    f.readline()
